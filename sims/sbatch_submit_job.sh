...
cp ${BASE_MACRO_DIR}/sis2_neg376mm.mac ${TEMP_MACRO_DIR}/sis2_neg376mm_${SLURM_JOB_ID}.mac

sed -i "s/neg376mm.*/neg376mm_${SLURM_JOB_ID}.root/g" ${TEMP_MACRO_DIR}/sis2_neg376mm_${SLURM_JOB_ID}.mac

shifter bash -c "source /global/homes/f/fnafis/LEGEND/setup_mage.sh;
MaGe ${TEMP_MACRO_DIR}/sis2_neg376mm_${SLURM_JOB_ID}.mac;
